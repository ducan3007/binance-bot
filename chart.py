...
PARI_MAP = {
    "5m": [{"tf": "5m", "view": 96, "mode": "heikin_ashi"}, {"tf": "15m", "view": 48, "mode": "kline"}],
    "15m": [{"tf": "15m", "view": 72, "mode": "heikin_ashi"}, {"tf": "30m", "view": 60, "mode": "kline"}],
...
def get_charts(title, PAIR, TIME_FRAME):
    try:
        ...
        if image1 and image2:
            output_path = f"{title}_{tftf1}_{tftf2}concatenated.png"
